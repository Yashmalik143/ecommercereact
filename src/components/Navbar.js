  ...
  return (
    <>
      <Nav>
        ...
        <NavMenu>
          <NavLink to="/">
            <AiTwotoneHome style={{ textDecoration: "none", padding: "5px" }} />
          </NavLink>
          <NavLink to="/About">
            <FcAbout style={{ textDecoration: "none", padding: "5px" }} />
          </NavLink>{" "}
          x
          <NavLink to="/Products">
            <SiProducthunt style={{ textDecoration: "none", padding: "5px" }} />
          </NavLink>
          <NavLink to="/Contact">
            <IoIosContact style={{ textDecoration: "none", padding: "5px" }} />
          </NavLink>
